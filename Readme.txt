...
3. If you need only the changed files for mobile apps in V7.0 check the update files in update files for apps from V6.1 to V7.0 folder. Please try to run this change log folder. 
