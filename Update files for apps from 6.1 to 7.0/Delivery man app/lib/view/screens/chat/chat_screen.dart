            ...
            child: Container(width: 40,height: 40,
              ...
              child: ClipRRect(
                ...
                child: FadeInImage.assetNetwork(
                  ...
                  imageErrorBuilder: (c,t,o) => Image.asset(Images.placeholderImage,fit: BoxFit.cover),
                ),
              ),
            ),
          )]),
      body: Column(children: [
        Consumer<ChatProvider>(builder: (context, chatProvider,child)=> Expanded(
                        ...
                        return InkWell(
                          onTap: () async {
                            if(Provider.of<ChatProvider>(context, listen: false).isSendButtonActive){
                              chatPro.sendMessage(_inputMessageController.text.trim(),chatPro.chatImage,widget.orderModel!.id).then((value){
